...
import carsSchema from '../module/carsValidateSchema.mjs'
const router = Router()
...
router.post('/create', uploadMiddleWare.single('image'), carValidationMiddleware(carsSchema), Cars.createCar)

router.post('/update/:id', uploadMiddleWare.single('image'), carValidationMiddleware(carsSchema), Cars.updateCar)
